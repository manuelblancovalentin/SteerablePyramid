function [params, pyr0] = textureAnalysis(im0, Nsc, Nor, Na)
...
% n = 1; figure, imshow(reshape(pyr0(pyrBandIndices(pind0,n)),pind0(n,:)),[])
...
% prepare pyr0 for output
pyr0 = arrayfun(@(n) reshape(pyr0(pyrBandIndices(pind0,n)),pind0(n,:)),(1:nband+1)','un',0);
